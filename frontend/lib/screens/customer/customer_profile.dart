  ...
  Future<void> _updateProfile() async {
    ...
    if (response['success'] == true) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Cập nhật trang cá nhân thành công!'), backgroundColor: Colors.green),
      );
      _initData();
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: const LinearGradient(colors: [orangeColor, Color(0xFFFF9E59)]),
                              ),
                              child: Stack(
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: _viewModel.user?['AnhDaiDien'] == null || _viewModel.user!['AnhDaiDien'].toString().isEmpty
                                        ? const Icon(Icons.person_rounded, size: 54, color: orangeColor)
                                        : null,
                                  ),
                                  Positioned(
                                    bottom: 0, right: 0,
                            ...
                            Text(
                              _viewModel.user?['HoTenNguoiDung'] ?? 'Khách hàng',
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: const Text('CẬP NHẬT THÔNG TIN', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, letterSpacing: 1.1)),
                              ),
                            ),
